...
(function(global) {
  ...
  // 7.2 Interface LegacyTextEncoder
   ...
   * @param {Object=} options
   */
  function LegacyTextEncoder(encoding, options) {
    if (!(this instanceof LegacyTextEncoder))
      return new LegacyTextEncoder(encoding, options);
    encoding = encoding !== undefined ? String(encoding) : DEFAULT_ENCODING;
    options = ToDictionary(options);
    /** @private */
    this._encoding = getEncoding(encoding);
  ...
  if (!('LegacyTextEncoder' in global))
