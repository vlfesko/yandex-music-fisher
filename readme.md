...
Скачивая расширение, вы считаетесь принявшим [условиями использования сервиса Яндекс.Музыка](https://legal.yandex.ru/music_termsofuse/) (далее – Условия).
В случае несогласия с какими-либо из положений указанных в Условиях, вы не вправе использовать сервис Яндекс.Музыка.
Ответственность за нарушения Условий разработчик расширения не несёт, поэтому используйте его на свой страх и риск.
